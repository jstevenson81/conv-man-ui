...
import ConvManToastContent from "../../pageParts/convManToastContent/ConvManToastContent";
...
const Conversions: React.FC<IConvManDashProps> = () => {
    ...
    const batchComplete = (createBatchRes: ICreateBatchResponse) => {
        ...
        if (createBatchRes.convOpsResp.hasErrors) {
            ...
            toast.warning(<ConvManToastContent
                    message={`Batch ${batch.cnv_batch} successfully created, however, there were validation errors.
      See the errors below.`}
            ...
            toast.error(
                <ConvManToastContent
                    message={`Batch ${batch.cnv_batch} was not successfully created.  There were errors loading the batch to the database (CNV_SPREADSHEET table).`}
                    customMessage={""}/>,
                ConvManToastrOpts(toastrConfig)
            );
            ...
            toast.error(<ConvManToastContent
                ...
                ConvManToastrOpts({autoClose: 10000, position: "top-center"})
            );
        } else {
            ...
            <div className="mt-8">
                <div className="flex items-start justify-between justify-items-stretch gap-4">
                    <div className="flex-grow">
                        <div
                            className="text-slate-600 border border-green-600 bg-green-200 px-2 py-4 rounded-lg flex items-center gap-2 mb-4">
                            <InformationCircleIcon className="w-8 h-8"/>
                            <p className="text-sm">
                                Click the new conversion button to start a conversion process. You can also create a new
                                pod. To
                    ...
                    <div className="flex-grow">
                        <div className="flex items-center justify-evenly button blue gap-1"
                    ...
                    <div className="flex-grow">
                        <div className="flex items-center justify-evenly button red gap-1"
                ...
                <div className="mt-4">
                    <ConvManErrorTableContainer batchName={selectedBatch.value}/>
                </div>
            </div>
